...
from .serializers import SignUpSerializer, ChangeUserInformationSerializer, ChangeUserPhotoSerializer, \
    ForgetPasswordSerializer, LoginSerializer, LoginRefreshTokenSerializer, LogoutSerializer, ResetPasswordSerializer
...
class ForgetPasswordView(APIView):
    ...
    def post(self, request, *args, **kwargs):
        ...
        return Response({
            'success': True,
            'message': 'Codingiz qaytadan yuborildi',
            'access': user.token()['access'],
            'refresh': user.token()['refresh_token'],
...
class LogoutView(APIView):
    ...
    def post(self, request, *args, **kwargs):
        serialize = LogoutSerializer(data=self.request.data)
